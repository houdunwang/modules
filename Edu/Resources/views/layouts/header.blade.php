        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-white pl-0">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav mr-auto mt-lg-0">
                        <li class="nav-item dropdown mr-3">
                            <a class="nav-link {{active_class(if_route_pattern('edu.front.system.index'),'active')}}"
                                href="{{module_link('edu.front.system.index')}}">课程</a>
                ...
                <li class="nav-item mr-3">
                    <a class="nav-link {{active_class(if_route_pattern('edu.front.lesson.index'),'active')}}"
                ...
                <li class="nav-item dropdown mr-3">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="{{route('document.front.article.show',$article)}}">
                            {{$article['title']}}
                        </a>
                        <div class="dropdown-divider"></div>
                        @endforeach
                ...
                <li class="nav-item dropdown mr-3">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{module_link('edu.front.video.index')}}">更新列表</a>
                        <div class="dropdown-divider"></div>
                ...
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right rounded-0"
                            ...
                            <a class="dropdown-item" href="{{route('user.home',auth()->user())}}">个人中心</a>
                            <div class="dropdown-divider"></div>
